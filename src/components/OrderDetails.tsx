    ...
    <div>
        {
            ...
            <button onClick={()=> dispatch(resetOrder())} className='mt-5 border-[1px] border-gray-300 py-1 px-4 font-medium rounded-md hover:border-orange-600 cursor-pointer duration-200'>Reset Order</button>
        </div>): (
            <div className='py-10 bg-white text-black text-2xl text-center'>
                <p>Nothing to Show</p>
                <Link href={'/'}>
                    <button className="bg-black text-slate-100 w-44 h-12 rounded-full text-base font-semibold mt-2 hover:bg-orange-600 duration-200">Continue Shopping</button>
                </Link>
            </div>
        )}
    </div>
